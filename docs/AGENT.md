...
1. **Familiarization**: Before making any changes, read `docs/wiki/index.md` and `[YOUR-ORG]-REPO-BIBLE.md` (if available in the root repo). Know your place.
...
[Specific instructions for agent setup, e.g., "Run `npm install` upon session start". Don't break anything.]
