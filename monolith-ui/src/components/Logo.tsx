  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="url(#monolith_grad_comp)"
        stroke="var(--brand-primary, #4285f4)"
        strokeWidth="2"
      />

      {/* Perspective/Depth lines */}
      <path
        d="M60 40 L70 30 L150 30 L150 150 L140 160"
        stroke="var(--brand-primary, #4285f4)"
        strokeWidth="1.5"
        strokeOpacity="0.5"
      />
      ...
      <path
        d="M60 70 H140 M60 100 H140 M60 130 H140"
        stroke="var(--brand-primary, #4285f4)"
        strokeWidth="0.5"
        strokeOpacity="0.3"
      />
      <path
        d="M85 40 V160 M115 40 V160"
        stroke="var(--brand-primary, #4285f4)"
        strokeWidth="0.5"
        strokeOpacity="0.3"
      />
      ...
      <rect
        ...
        width="15"
        height="4"
        fill="var(--brand-secondary, #c5a9f5)"
        fillOpacity="0.8"
      />
      <rect
        x="90"
