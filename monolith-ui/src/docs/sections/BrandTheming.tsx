  ...
  return (
    <section className="doc-section" id="branding">
      ...
      <div className="subsection">
        ...
        <div className="canvas" style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '24px', background: 'var(--ui-surface-0)', borderRadius: 'var(--ui-r-lg)', boxShadow: 'var(--ui-inset-deep)' }}>
          <div className="canvas-label">Modular Brand Integration</div>
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', alignItems: 'center' }}>
            <div className="surface-card" style={{ display: 'flex', gap: '12px', alignItems: 'center', padding: '12px 16px' }}>
              <div style={{ width: '12px', height: '12px', background: 'var(--brand-primary)', borderRadius: '50%', boxShadow: '0 0 8px var(--ui-accent-primary-glow)' }}></div>
              <span style={{ fontSize: '11px', fontWeight: 800, fontFamily: 'var(--ui-font-mono)', textTransform: 'uppercase' }}>{brand.replace('brand-', '')}</span>
            </div>
            ...
            <div className="surface-card" style={{ padding: '10px 14px', borderStyle: 'dashed' }}>
              <span style={{ fontSize: '11px', color: 'var(--ui-text-tertiary)', fontFamily: 'var(--ui-font-mono)' }}>SECONDARY_SLOT</span>
            </div>
            
            <div className="progress-bar" style={{ width: '120px', height: '8px', background: 'var(--ui-surface-3)', border: '1px solid var(--ui-border-default)', borderRadius: 'var(--ui-r-pill)', overflow: 'hidden' }}>
              <div className="progress-fill" style={{ width: '65%', height: '100%', background: 'var(--brand-primary)', boxShadow: '0 0 10px var(--ui-accent-primary-glow)' }}></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="subsection">
        ...
        <p className="section-desc">Override these variables in <span className="icode">@layer brand</span> to create a new station skin.</p>
        <div className="code">
          <span className="c">/* Station Skin Definition */</span><br/>
          <span className="k">.brand-station-x64</span> {'{'}<br/>
          &nbsp;&nbsp;<span className="v">--brand-primary</span>:        <span className="s">#22D3EE</span>;<br/>
          &nbsp;&nbsp;<span className="v">--brand-primary-light</span>:  <span className="s">#67E8F9</span>;<br/>
          &nbsp;&nbsp;<span className="v">--brand-primary-bg</span>:     <span className="s">rgba(34,211,238,0.12)</span>;<br/>
          &nbsp;&nbsp;<span className="v">--brand-primary-border</span>: <span className="s">rgba(34,211,238,0.25)</span>;<br/>
          &nbsp;&nbsp;<span className="v">--brand-primary-glow</span>:   <span className="s">rgba(34,211,238,0.18)</span>;<br/>
          &nbsp;&nbsp;<span className="v">--brand-secondary</span>:      <span className="s">#A855F7</span>;<br/>
          &nbsp;&nbsp;<span className="v">--brand-secondary-bg</span>:   <span className="s">rgba(168,85,247,0.12)</span>;<br/>
          &nbsp;&nbsp;<span className="c">/* typography: */</span><br/>
          &nbsp;&nbsp;<span className="v">--brand-font-sans</span>:      <span className="s">'DM Sans'</span>;<br/>
          &nbsp;&nbsp;<span className="v">--brand-font-mono</span>:      <span className="s">'DM Mono'</span>;<br/>
          {'}'}
        </div>
      </div>
      ...
      <div className="subsection" id="darklight">
        ...
        <div className="grid2" style={{ gap: '20px' }}>
          <div className="surface-card elevated" style={{ padding: '24px', background: 'var(--ui-surface-1)' }}>
