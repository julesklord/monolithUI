  ...
  return (
    <section className="doc-section" id="components">
      ...
      <h2 className="section-title">
        <em>Components</em> Library
      </h2>
      <p className="section-desc">
        Every component references only semantic tokens. Swap the brand layer
        and all components rebrand automatically.
      </p>
            ...
            <CommandBar platform="macos" title="monolith-ui">
              <CommandBarSegment variant="primary">
                <svg width="9" height="9" viewBox="0 0 28 28" fill="none">
                  <path
                    d="M14 3L16.2 10.8L24 14L16.2 17.2L14 25L11.8 17.2L4 14L11.8 10.8Z"
                    fill="currentColor"
                  />
                </svg>
                gemini-2.0-flash
      ...
      <div className="grid-2">
        <div className="subsection" id="dock">
          ...
          >
            ...
            <div
              className="dock dock-bottom dock-floating"
              style={{
                position: "absolute",
                bottom: "20px",
                left: "50%",
            ...
            <div
              className="dock-panel dock-panel-anchored-right"
              style={{
                width: "160px",
                height: "100%",
                position: "absolute",
            ...
            >
              <div className="dock-panel-header">
                <span className="dock-panel-title">Props</span>
              </div>
              <div className="dock-panel-content">
                <div className="dock-panel-section">
                  <div className="dock-panel-section-title">Visual</div>
                </div>
              </div>
            </div>
          </div>
          <div className="canvas-label">
            Multi-position support (top/bottom/left/right) · Variants: floating
            or anchored.
          </div>
        </div>
        ...
        <div className="subsection" id="drawers">
              ...
              <div className="drawer-body">
                <div className="sess-item active">
                  ...
                  <div className="sess-info">
                    <div className="sess-title">Refactor: Layout</div>
                  </div>
                </div>
                <div className="sess-item">
                  ...
                  <div className="sess-info">
                    <div className="sess-title">Fix: Routing</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="canvas-label">
            Spring physics for entry/exit · Handle-based interaction.
          </div>
        </div>
      </div>
      ...
      <div className="subsection" id="web-extras">
        ...
        <div className="grid-2">
          <div>
            ...
            <Card style={{ padding: "0", overflow: "hidden" }}>
              ...
              <div style={{ padding: "16px" }}>
                ...
                >
                  How we migrated a boxy grid to a gravity-based system.
                </div>
                <div
                  style={{
                    marginTop: "16px",
                ...
                >
                  READ_MORE <CaretRight size={14} weight="duotone" />
                </div>
              </div>
            </Card>
          </div>
          <div>
            ...
            >
              ...
              >
                Build the{" "}
                <span style={{ color: "var(--brand-primary)" }}>Future</span>
              </h3>
              <p
                style={{
                  fontSize: "13px",
              ...
              >
                The industrial-modern design system for professional
                workstations.
              </p>
              <div
                style={{
        ...
        <div className="canvas-label">
          Web-specific components use broader spacing and typography ramps for
      ...
      <div className="grid-2">
        <div className="subsection" id="buttons">
          ...
          <div className="canvas col" style={{ gap: "16px" }}>
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              <Button
                variant="ghost"
                leftIcon={<Download size={14} weight="duotone" />}
              >
                Download
              </Button>
          ...
          <div className="canvas-label">
            Transitions: fast (110ms) · Active scale down (0.97).
          </div>
        </div>
        ...
        <div className="subsection" id="inputs">
          ...
          <div className="canvas col" style={{ gap: "12px" }}>
            <Input
              placeholder="Search..."
              leftIcon={<MagnifyingGlass size={14} weight="duotone" />}
            />
            <Input
              placeholder="Password"
              type="password"
              leftIcon={<Key size={14} weight="duotone" />}
            />
            <Input
              placeholder="Invalid field"
              leftIcon={<WarningCircle size={14} weight="duotone" />}
              status="invalid"
            />
          </div>
          <div className="canvas-label">
            Focus rings use primary-glow · Semantic error states.
          </div>
        </div>
      </div>
      ...
      <div className="grid-2">
        <div className="subsection" id="pills">
          ...
          <div className="canvas-label">
            Semantic color ramps · Monospace meta labels.
          </div>
        </div>
            ...
            >
              ...
              <div className="progress-bar">
                <div
                  ...
                  style={{ width: "35%", background: "var(--ui-warning)" }}
                ></div>
              </div>
            </div>
          </div>
          <div className="canvas-label">
            Indeterminate spinners · Linear progress tracking.
          </div>
        </div>
      </div>
      ...
      <div className="subsection" id="cards">
        ...
        <div className="grid-2">
          <Card>
            ...
            <div
              style={{ fontSize: "13px", color: "var(--ui-text-secondary)" }}
            >
              Default container for main canvas items.
            </div>
          </Card>
