  ...
  return (
    <section className="doc-section" id="motion">
      ...
      <p className="section-desc">
        Physics-based animation is the primary differentiator of this system.
        Every curve is chosen to mimic a physical force. Never use ease-linear
        ...
        <div className="canvas col" style={{ padding: "20px 24px", gap: "0" }}>
          <div className="motion-row">
            ...
            <div className="motion-info">
              ...
              <div className="motion-use">
                Drawers open · dock-btn hover (scale) · pills appear · send-btn
                press · any element entering the DOM
              </div>
            </div>
          ...
          <div className="motion-row">
            <div
              ...
              style={{
                background: "var(--ui-accent-secondary-bg)",
            ...
            <div className="motion-info">
              ...
              <div className="motion-use">
                Backdrop fade in · card appear · tooltip show · page transition
                · bubbles entering
              </div>
            </div>
          ...
          <div className="motion-row">
            ...
            <div className="motion-info">
              ...
              <div className="motion-use">
                Hover color transitions · border changes · toggle · background
                fade
              </div>
            </div>
          ...
          <div className="motion-row">
            ...
            <div className="motion-info">
              ...
              <div className="motion-use">
                Loading spinner rotation · logo sunrise pulse. NEVER for
          ...
          <div className="motion-row" style={{ borderBottom: "none" }}>
            ...
            <div className="motion-info">
              ...
              <div className="motion-curve">
                ease-in-out with 150ms delay per item
              </div>
              <div className="motion-use">
                List items appearing (sessions, MCP cards) · typing dots ·
                skeleton loaders
              </div>
            </div>
      ...
      <div className="subsection">
        ...
        <div className="rule-box">
          <p>
            The <span className="icode">1.56</span> value in the spring curve's
            y2 parameter creates overshoot — the element goes slightly past its
            target then settles back. This is the physical behavior of a spring.
            It's the single most impactful detail that separates polished motion
            from generic CSS transitions. The overshoot is subtle (~3-4% past
            target) and lasts under 100ms. It should be felt, not seen.
          </p>
        </div>
        <div
          className="canvas"
        ...
        >
          ...
          >
            /* Banned — never use for UI interactions */
          </div>
          <div
            style={{
              fontSize: "11px",
          ...
          >
            transition: transform 300ms ease; /* → — same as ease-in-out */
          </div>
        </div>
      </div>
      <div className="subsection">
        ...
        <p className="section-desc">
          Interact with these buttons to feel the difference between the physics
          engine and standard linear motion.
        </p>
        <div className="canvas row" style={{ gap: "16px" }}>
          <button
            className="btn primary"
            style={{ transition: "transform 420ms var(--ui-ease-spring)" }}
          >
            SPRING_ACTION
          </button>
          <button
            className="btn secondary"
            style={{ transition: "transform 320ms var(--ui-ease-out)" }}
          >
            EASE_OUT_ACTION
          </button>
          <button
            className="btn ghost"
            style={{ border: "1.5px solid var(--ui-border-default)" }}
          >
            DEFAULT_TRANSITION
          </button>
        </div>
        <div className="canvas-label">
          Try hovering or clicking to trigger the spring scaling effect
        </div>
      </div>
    </section>
  );
