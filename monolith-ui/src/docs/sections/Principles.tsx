...
export const Principles: React.FC = () => {
  const principles = [
    {
      icon: <Stack weight="duotone" size={22} />,
    ...
    {
      icon: <ArrowBendUpRight weight="duotone" size={22} />,
    ...
    {
      icon: <Sun weight="duotone" size={22} />,
      color: "var(--ui-info)",
    ...
    {
      icon: <CircleHalfTilt weight="duotone" size={22} />,
    ...
    {
      icon: <Ruler weight="duotone" size={22} />,
    ...
    {
      icon: <CodeBlock weight="duotone" size={22} />,
      color: "var(--ui-danger)",
  ...
  return (
    <section className="doc-section" id="principles">
      ...
      <p className="section-desc">
        Six rules that govern every decision in this system. If a design choice
        conflicts with these, the choice is wrong — not the rule.
      </p>
          ...
          >
            ...
            <div
              style={{
                ...
                color: "var(--ui-text-secondary)",
                lineHeight: "var(--ui-leading-loose)",
              }}
            >
              {p.desc}
            </div>
      ...
      <div className="warn-box" style={{ marginTop: "32px" }}>
        <p>
          <strong>These are not guidelines — they are axioms.</strong>{" "}
          Guidelines can be broken when the situation warrants it. Axioms
          cannot. If your design breaks one of these principles, you are
          building a different system, not a variant of this one.
        </p>
      </div>
    </section>
  );
