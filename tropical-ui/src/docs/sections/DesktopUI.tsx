              ...
              <div style={{ width: '240px', background: 'var(--ui-surface-2)', borderRight: '1px solid var(--ui-border-subtle)', padding: '12px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div>
                   ...
                   <div style={{ padding: '10px', background: 'var(--ui-surface-0)', border: '1px solid var(--brand-primary)', borderRadius: '3px' }}>
                     <div style={{ fontSize: '11px', fontWeight: 700, color: '#fff' }}>TropicalDev-Design</div>
                     <div style={{ fontSize: '10px', color: 'var(--ui-text-tertiary)', marginTop: '2px' }}>k:/source/repos/tropical-ui</div>
                   </div>
                </div>
                <div>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
               <div style={{ flex: 1, padding: '40px', display: 'flex', gap: '32px', alignItems: 'center' }}>
                  ...
                  <div style={{ flex: 1 }}>
                     ...
                     <div style={{ fontSize: '14px', color: 'var(--brand-primary)', fontFamily: 'var(--ui-font-mono)', fontWeight: 700 }}>TROPICAL_ENGINE // 192KHZ</div>
           ...
           <div style={{ minWidth: '800px', display: 'flex', flexDirection: 'column', height: '400px' }}>
             ...
             <div style={{ flex: 1, display: 'flex' }}>
                ...
                <div style={{ flex: 1, padding: '24px', fontFamily: 'var(--ui-font-mono)', fontSize: '13px', lineHeight: '1.6' }}>
                   <div style={{ color: 'var(--ui-text-tertiary)' }}>// TropicalUI v0.8 Core</div>
