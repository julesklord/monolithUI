      ...
      <div className="subsection">
        ...
        <div className="grid-2">
           <div className="subsection-meta">
              <p className="section-desc">To maintain balance, we follow the <strong>Tropical Ratio (1:4)</strong>. The core must always occupy at least 75% of the total visual mass to ensure focus.</p>
