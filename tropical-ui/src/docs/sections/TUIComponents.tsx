...
export const TUIComponents: React.FC = () => {
  return (
    <section className="doc-section" id="tui-system">
      ...
      <p className="section-desc">The official specification for high-density, industrial terminal interfaces. TropicalUI TUIs are built for technical excellence, using ASCII/Unicode primitives as the primary design language.</p>

      {/* SECTION 1: CORE PHILOSOPHY */}
      <div className="subsection">
        <div className="subsection-title">1. The Tropical Industrial Philosophy</div>
        <p className="section-desc">A TropicalUI terminal is not a "minimalist" console; it is a <strong>Command Station</strong>. It follows three core laws:</p>
...
'-,|   \\__/   |,-'
  ...
  M A N G O F E T C H`}
          ...
          <div className="grid-2">
             ...
             <div className="canvas" style={{ padding: '24px', background: 'var(--ui-surface-0)', fontFamily: 'var(--ui-font-mono)', fontSize: '12px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                   ...
                   <span style={{ color: 'var(--ui-text-primary)' }}>tropical deploy --env production</span>
        ...
        <div className="subsection">
          ...
          <p className="section-desc">When implementing TropicalUI in Rust using **Ratatui**, we utilize a constraint-based layout engine. Below is the standard boilerplate for a Tropical Orbital view.</p>
...
&nbsp;&nbsp;.<span className="n">split</span>(frame.<span className="n">size</span>());
        ...
        <div className="subsection">
          ...
          <p className="section-desc">To ensure coherence across all TropicalDev CLI tools, every application must follow one of these three architectural patterns.</p>
