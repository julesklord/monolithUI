        ...
        <div className="canvas" style={{ padding: '0', background: 'var(--ui-surface-0)', borderRadius: '3px', border: '1.5px solid var(--ui-border-default)', overflowX: 'auto', overflowY: 'hidden' }}>
          <div style={{ minWidth: '800px', height: '400px', display: 'flex', flexDirection: 'column' }}>
             ...
             <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '40px' }}>
                ...
                <p style={{ fontSize: '14px', color: 'var(--ui-text-tertiary)', maxWidth: '400px', marginBottom: '32px' }}>Experience spatial audio with zero latency. Powered by the TropicalDev core engine.</p>
